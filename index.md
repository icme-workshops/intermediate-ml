...
- Session 1 (8:00 AM to 9:30 AM) [[slides](/docs/intro.pdf)]
  ...
  - <i>Additional resources:</i> Excellent [free textbook](https://www.statlearning.com/) with code examples (SVM example 9.6.2, ROC example 9.6.3); great free Convex Optimization [textbook](https://web.stanford.edu/~boyd/cvxbook/)
